...
void MX_TIM2_Init(void)
{
  ...
  sConfigOC.Pulse = 19500-2000/270*30;
  ...
  sConfigOC.Pulse = 19500-2000/360*54;
  if (HAL_TIM_PWM_ConfigChannel(&htim2, &sConfigOC, TIM_CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
  sConfigOC.Pulse = 19500-2000/180*148;
...
void MX_TIM9_Init(void)
{
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = 19500-2000/180*5;
  sConfigOC.OCPolarity = TIM_OCPOLARITY_LOW;
  sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
  ...
  sConfigOC.Pulse = 19500-2000/180*42;
...
/*-------------------------------------------------------------------------------------------------------*/
	...
	HAL_TIM_PWM_Start(&htim9,TIM_CHANNEL_1);//开启PWM通道1
	HAL_TIM_PWM_Start(&htim9,TIM_CHANNEL_2);//开启PWM通道2
	HAL_TIM_PWM_Start(&htim11,TIM_CHANNEL_1);//开启PWM通道1	
...
//void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)//在main里面有（cube自动生成 就不放这了）
//{
