...
//int16_t Xo=-79,Yo=-127,Zo=46;
//int16_t Xo=-374,Yo=-391,Zo=206;//carbon_1
//int16_t Xo=-259,Yo=-108,Zo=156;//test platform.
//int16_t Xo=56,Yo=-115,Zo=-80;//test platform copter.

//int16_t Xo=-17,Yo=-15,Zo=-65;//small_copter
int16_t Xo=-59,Yo=-164,Zo=-26;
